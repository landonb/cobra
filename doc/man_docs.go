...
// current time if Date if unset and will use "Auto generated by landonb/cobra"
...
func fillHeader(header *GenManHeader, name string) {
	...
	if header.Source == "" {
		header.Source = "Auto generated by landonb/cobra"
	}
}
...
func genMan(cmd *cobra.Command, header *GenManHeader) []byte {
	...
	if !cmd.DisableAutoGenTag {
		fmt.Fprintf(buf, "# HISTORY\n%s Auto generated by landonb/cobra\n", header.Date.Format("2-Jan-2006"))
	}
	return buf.Bytes()
}
